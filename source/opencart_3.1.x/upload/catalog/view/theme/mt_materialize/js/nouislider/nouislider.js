...
// Interface
    ...
    function closure ( target, options, originalOptions ){
        ...
        function fixEvent ( e, pageOffset, eventTarget ) {
			...
			if (touch) { /* todo-materialize Just suppressing some console errors */
