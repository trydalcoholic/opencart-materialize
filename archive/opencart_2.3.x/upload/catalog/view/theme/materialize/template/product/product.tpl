	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col <?php echo $main; ?>" itemscope itemtype="http://schema.org/Product">
				<meta itemprop="url" content="<?php echo $share; ?>">
				<?php if ($thumb_small) { ?>
						...
						<div class="card-panel product-info">
							...
							<div class="row valign-wrapper">
								...
								<div class="col s4 center">
									...
									<a href="<?php echo $manufacturers; ?>" target="_blank" rel="noopener"><?php echo ($manufacturers_img) ? '<img class="responsive-img lazyload" src="'.$img_loader.'" data-src="'.$manufacturers_img.'" title="'.$manufacturer.'" alt="'.$manufacturer.'">' : '' ;?></a>
									<?php } ?>
								</div>
							</div>
							<?php if ($product_spec && $product_spec != '0000-00-00') { ?>
							...
							<ul class="collection z-depth-1">
								...
								<?php if ($size_chart) { ?>
								<li class="collection-item">
									<i class="material-icons blue-grey-text text-darken-4 left">straighten</i><a class="deep-orange-text text-accent-3 text-bold modal-trigger" href="#modal-size-chart" rel="nofollow"><?php echo $text_size_chart; ?></a>
								</li>
								<?php } ?>
							</ul>
							<?php } ?>
									...
									<?php foreach ($options as $option) { ?>
										...
										<div class="section">
											<div class="input-field">
												...
												<input type="text" name="option[<?php echo $option['product_option_id']; ?>]" value="" id="input-option<?php echo $option['product_option_id']; ?>">
											</div>
										</div>
										<?php } ?>
										...
										<div class="section">
											<div class="input-field">
												...
												<label class="text-bold<?php echo ($option['required'] ? ' required' : ''); ?> for="input-option<?php echo $option['product_option_id']; ?>"><?php echo $option['name']; ?></label>
												<textarea name="option[<?php echo $option['product_option_id']; ?>]" rows="5" id="input-option<?php echo $option['product_option_id']; ?>" class="materialize-textarea"></textarea>
											</div>
										</div>
										<?php } ?>
										...
										<div class="section">
											...
											<div class="file-field input-field">
												<button type="button" id="button-upload<?php echo $option['product_option_id']; ?>" class="btn waves-effect waves-light blue-grey lighten-1">
										...
										<div class="section">
											<div class="input-field">
												...
												<label class="text-bold<?php echo ($option['required'] ? ' required' : ''); ?>" for="input-option<?php echo $option['product_option_id']; ?>"><?php echo $option['name']; ?></label>
												<input type="text" name="option[<?php echo $option['product_option_id']; ?>]" value="" id="input-option<?php echo $option['product_option_id']; ?>" class="datepicker">
											</div>
										</div>
										<?php } ?>
										...
										<div class="section">
											<div class="input-field">
												...
												<label class="text-bold<?php echo ($option['required'] ? ' required' : ''); ?>" for="input-option<?php echo $option['product_option_id']; ?>"><?php echo $option['name']; ?></label>
												<input type="text" name="option[<?php echo $option['product_option_id']; ?>]" value="" id="input-option<?php echo $option['product_option_id']; ?>" class="timepicker">
											</div>
										</div>
										<?php } ?>
									<?php } ?>
				...
				<div class="col s12 m4">
					<div class="card sticky-action large hoverable href-underline">
						...
						<div class="card-image">
							...
							<a href="<?php echo $product['href']; ?>"><img class="responsive-img lazyload" src="<?php echo $img_loader; ?>" data-src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>"></a>
						</div>
...
<aside>
	...
	<ul id="side-share" class="side-nav href-underline">
		...
		<li>
			<a class="waves-effect waves-default" href="whatsapp://send?text=<?php echo str_replace(' ', '%20', htmlspecialchars($heading_title)).'%20'.urlencode($share); ?>" data-action="share/whatsapp/share" rel="nofollow">
				<span class="side-share__item">
		...
		<li>
			<a class="waves-effect waves-default" href="viber://forward?text=<?php echo str_replace(' ', '%20', htmlspecialchars($heading_title)).'%20'.urlencode($share); ?>" rel="nofollow">
				<span class="side-share__item">
	...
	<?php if ($options) { ?>
		<?php foreach ($options as $option) { ?>
			...
			$('.datepicker').pickadate({
				monthsFull: ['<?php echo $text_months_full_january; ?>', '<?php echo $text_months_full_february; ?>', '<?php echo $text_months_full_march; ?>', '<?php echo $text_months_full_april; ?>', '<?php echo $text_months_full_may; ?>', '<?php echo $text_months_full_june; ?>', '<?php echo $text_months_full_july; ?>', '<?php echo $text_months_full_august; ?>', '<?php echo $text_months_full_september; ?>', '<?php echo $text_months_full_october; ?>', '<?php echo $text_months_full_november; ?>', '<?php echo $text_months_full_december; ?>'],
				monthsShort: ['<?php echo $text_months_short_january; ?>', '<?php echo $text_months_short_february; ?>', '<?php echo $text_months_short_march; ?>', '<?php echo $text_months_short_april; ?>', '<?php echo $text_months_short_may; ?>', '<?php echo $text_months_short_june; ?>', '<?php echo $text_months_short_july; ?>', '<?php echo $text_months_short_august; ?>', '<?php echo $text_months_short_september; ?>', '<?php echo $text_months_short_october; ?>', '<?php echo $text_months_short_november; ?>', '<?php echo $text_months_short_december; ?>'],
				weekdaysFull: ['<?php echo $text_weekdays_full_sunday; ?>', '<?php echo $text_weekdays_full_monday; ?>', '<?php echo $text_weekdays_full_tuesday; ?>', '<?php echo $text_weekdays_full_wednesday; ?>', '<?php echo $text_weekdays_full_thursday; ?>', '<?php echo $text_weekdays_full_friday; ?>', '<?php echo $text_weekdays_full_saturday; ?>'],
				weekdaysShort: ['<?php echo $text_weekdays_short_sunday; ?>', '<?php echo $text_weekdays_short_monday; ?>', '<?php echo $text_weekdays_short_tuesday; ?>', '<?php echo $text_weekdays_short_wednesday; ?>', '<?php echo $text_weekdays_short_thursday; ?>', '<?php echo $text_weekdays_short_friday; ?>', '<?php echo $text_weekdays_short_saturday; ?>'],
				today: '<?php echo $button_date_today; ?>',
				clear: '<?php echo $button_datetime_clear; ?>',
				close: '<?php echo $button_datetime_done; ?>',
			...
			$('.timepicker').pickatime({
				...
				cleartext: '<?php echo $button_datetime_clear; ?>',
				canceltext: '<?php echo $button_datetime_done; ?>',
				autoclose: true
			});
			<?php } ?>
		<?php } ?>
