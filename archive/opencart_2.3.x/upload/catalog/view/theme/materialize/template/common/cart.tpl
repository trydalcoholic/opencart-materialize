<button type="button" id="cart" data-target="modal-cart" class="btn-floating btn-large waves-effect waves-light waves-circle modal-trigger z-depth-4 <?php echo $color_cart; ?>">
	<i class="material-icons <?php echo $color_cart_text; ?>">shopping_cart</i>
	<small id="cart-total" class="btn-floating z-depth-1 <?php echo $color_cart_total.' '.$color_cart_total_text; ?>"><?php echo $text_items; ?></small>
</button>
		...
		<div class="container">
			...
			<ul class="collection z-depth-2">
				...
				<li class="collection-item avatar">
					...
					<button onclick="cart.remove('<?php echo $product['cart_id']; ?>');" title="<?php echo $button_remove; ?>" class="btn-floating transparent z-depth-0 waves-effect secondary-content activator"><i class="material-icons black-text">remove_shopping_cart</i></button>
				</li>
				<?php } ?>
