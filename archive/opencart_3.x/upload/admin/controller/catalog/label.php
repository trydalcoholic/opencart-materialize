...
class ControllerCatalogLabel extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/label', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href'	=> $this->url->link('catalog/label', 'user_token=' . $this->session->data['user_token'] . $url, true)
		);

		$data['add'] = $this->url->link('catalog/label/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('catalog/label/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		foreach ($results as $result) {
			$data['labels'][] = array(
				...
				'edit'			=> $this->url->link('catalog/label/edit', 'user_token=' . $this->session->data['user_token'] . '&label_id=' . $result['label_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('catalog/label', 'user_token=' . $this->session->data['user_token'] . '&sort=mld.name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('catalog/label', 'user_token=' . $this->session->data['user_token'] . '&sort=ml.sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('catalog/label', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['label_id'])) {
			$data['action'] = $this->url->link('catalog/label/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/label/edit', 'user_token=' . $this->session->data['user_token'] . '&label_id=' . $this->request->get['label_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/label', 'user_token=' . $this->session->data['user_token'] . $url, true);
