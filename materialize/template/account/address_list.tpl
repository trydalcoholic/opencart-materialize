			...
			<div class="container">
				...
				<div id="content" class="col <?php echo $main; ?>">
					...
					<div class="card-panel">
						<div class="row">
							<h2 class="col s12"><?php echo $text_address_book; ?></h2>
							<?php if ($addresses) { ?>
							<div class="col s12">
							...
							<div class="col s12">
								<div class="section">
									...
									<a href="<?php echo $add; ?>" class="btn waves-effect waves-light red right href-underline"><?php echo $button_new_address; ?></a>
								</div>
							</div>
						</div>
					</div>
