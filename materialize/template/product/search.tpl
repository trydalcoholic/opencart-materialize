				...
				<div class="row">
					<div id="content" class="col <?php echo $main; ?> section href-underline">
						...
						<ul class="collapsible" data-collapsible="expandable">
							<li>
								<div class="collapsible-header bold active"><label for="input-search"><?php echo $entry_search; ?></label><i class="material-icons right">arrow_drop_down</i></div>
								<div class="collapsible-body white">
									<div class="row">
										<div class="col s6 input-field">
											<input type="text" name="search" value="<?php echo $search; ?>" placeholder="<?php echo $text_keyword; ?>" id="input-search">
											<label class="bold"><?php echo $text_searched; ?></label>
										</div>
										<div class="col s6 input-field">
											...
											<label class="bold"><?php echo $text_refine; ?></label>
										</div>
										<div class="col s12">
											<div class="row">
								...
								<div class="collapsible-body white">
									<div class="row">
										<div class="col s6 m6 input-field inline">
											...
											<label class="bold"><?php echo $text_sort; ?></label>
										</div>
										<div class="col s6 m6 input-field inline">
