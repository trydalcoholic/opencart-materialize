...
<script type="application/ld+json">
								...
								<blockquote class="blockquote-note blue-grey lighten-5 z-depth-1">
									...
									<ul>
										...
										<li>
											...
											<a href="<?php echo $manufacturers; ?>" target="_blank" rel="noopener"><span itemprop="brand"><?php echo $manufacturer; ?></span></a>
										</li>
										<?php } ?>
										...
										<?php if ($sku) { ?>
										<li>
											<span class="text-bold"><?php echo $text_sku; ?></span>
											<?php echo $sku; ?>
										</li>
										<?php } ?>
									</ul>
	...
	<ul id="side-share" class="side-nav href-underline">
		<li>
			<a class="waves-effect waves-default" href="https://vk.com/share.php?url=<?php echo $url_page; ?>" rel="nofollow noopener" target="_blank">
		...
		<li>
			<a class="waves-effect waves-default" href="https://www.facebook.com/sharer.php?u=<?php echo $url_page; ?>" rel="nofollow noopener" target="_blank">
				<span class="side-share__item">
		...
		<li>
			<a class="waves-effect waves-default" href="https://plus.google.com/share?url=<?php echo $url_page; ?>" rel="nofollow noopener" target="_blank">
				<span class="side-share__item">
		...
		<li>
			<a class="waves-effect waves-default" href="https://www.odnoklassniki.ru/dk?st.cmd=addShare&st.s=1&st._surl=<?php echo $url_page; ?>" rel="nofollow noopener" target="_blank">
				<span class="side-share__item">
		...
		<li>
			<a class="waves-effect waves-default" href="https://twitter.com/share?url=<?php echo $url_page; ?>" rel="nofollow noopener" target="_blank">
				<span class="side-share__item">
		...
		<li>
			<a class="waves-effect waves-default" href="https://telegram.me/share/url?url=<?php echo $url_page; ?>" rel="nofollow noopener" target="_blank">
				<span class="side-share__item">
		...
		<li>
			<a class="waves-effect waves-default" href="whatsapp://send?text=<?php echo str_replace(' ', '%20', htmlspecialchars($heading_title)).'%20'.urlencode($url_page); ?>" data-action="share/whatsapp/share" rel="nofollow noopener" target="_blank">
				<span class="side-share__item">
		...
		<li>
			<a class="waves-effect waves-default" href="viber://forward?text=<?php echo str_replace(' ', '%20', htmlspecialchars($heading_title)).'%20'.urlencode($url_page); ?>" rel="nofollow noopener" target="_blank">
				<span class="side-share__item">
		...
		<li>
			<a class="waves-effect waves-default" href="https://web.skype.com/share?url=<?php echo $url_page; ?>" rel="nofollow noopener" target="_blank">
				<span class="side-share__item">
