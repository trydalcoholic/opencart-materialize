	...
	<div class="col s12 l6">
		<div id="account" class="card-panel z-depth-2">
			...
			<div class="input-field">
				...
				<label for="input-payment-password" class="active required"><?php echo $entry_password; ?></label>
			</div>
			<div class="input-field">
				<input type="password" name="confirm" value="" id="input-payment-confirm" class="validate">
				<label for="input-payment-confirm" class="active required"><?php echo $entry_confirm; ?></label>
			</div>
		</div>
	</div>
	<div class="col s12 l6">
