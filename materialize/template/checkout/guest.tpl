<div class="row">
	<div class="col s12 l6">
		<div id="account" class="card-panel z-depth-2">
			...
			<div class="input-field">
				<input type="text" name="telephone" value="<?php echo $telephone; ?>" id="input-payment-telephone" class="validate" placeholder="+7_(___)___-____" data-inputmask="'alias':'phone'">
			...
			<div class="input-field">
				...
				<label for="input-payment-fax" class="active"><?php echo $entry_fax; ?></label>
			</div>
		</div>
	</div>
	<div class="col s12 l6">
		<div id="address" class="card-panel z-depth-2">
			...
			<div class="input-field">
				...
				<label for="input-payment-company" class="active"><?php echo $entry_company; ?></label>
			</div>
			<div class="input-field">
				<input type="text" name="address_1" value="<?php echo $address_1; ?>" id="input-payment-address-1" class="validate">
				<label for="input-payment-address-1" class="active required"><?php echo $entry_address_1; ?></label>
			</div>
			<div class="input-field">
				...
				<label for="input-payment-address-2" class="active"><?php echo $entry_address_2; ?></label>
			</div>
			<div class="input-field">
				<input type="text" name="city" value="<?php echo $city; ?>" id="input-payment-city" class="validate">
				<label for="input-payment-city" class="active required"><?php echo $entry_city; ?></label>
			</div>
			<div class="input-field">
				<input type="text" name="postcode" value="<?php echo $postcode; ?>" id="input-payment-postcode" class="validate">
				<label for="input-payment-postcode" class="active required"><?php echo $entry_postcode; ?></label>
			</div>
			<div class="input-field">
