...
<div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;" class="section">
	<div class="row">
		<div class="input-field col s12">
			...
			<label for="input-shipping-firstname" class="active text-medium required"><?php echo $entry_firstname; ?></label>
		</div>
		<div class="input-field col s12">
			<input type="text" name="lastname" value="" id="input-shipping-lastname" class="validate">
			<label for="input-shipping-lastname" class="active text-medium required"><?php echo $entry_lastname; ?></label>
		</div>
		<div class="input-field col s12">
		...
		<div class="input-field col s12">
			...
			<label for="input-shipping-address-1" class="text-medium required"><?php echo $entry_address_1; ?></label>
		</div>
		<div class="input-field col s12">
		...
		<div class="input-field col s12">
			...
			<label for="input-shipping-city" class="text-medium required"><?php echo $entry_city; ?></label>
		</div>
		<div class="input-field col s12">
...
<div class="row">
	<div class="col s12">
		<div class="section">
			<input type="button" value="<?php echo $button_continue; ?>" id="button-shipping-address" class="btn waves-effect waves-light red right">
		</div>
	</div>
</div>
<script>
