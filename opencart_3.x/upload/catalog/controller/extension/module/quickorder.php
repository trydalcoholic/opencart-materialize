...
class ControllerExtensionModuleQuickorder extends Controller {
	public function index() {
		...
		$data['module_quickorder_success'] = $module_quickorder[$this->config->get('config_language_id')]['success'];
		$data['module_quickorder_button'] = $module_quickorder[$this->config->get('config_language_id')]['button'];
		$data['module_quickorder_time'] = $this->config->get('module_quickorder_time');
