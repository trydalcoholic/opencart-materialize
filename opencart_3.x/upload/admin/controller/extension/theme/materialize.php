...
class ControllerExtensionThemeMaterialize extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['theme_materialize_directory'])) {
			$data['theme_materialize_directory'] = $this->request->post['theme_materialize_directory'];
		} elseif (isset($setting_info['theme_materialize_directory'])) {
			$data['theme_materialize_directory'] = $setting_info['theme_materialize_directory'];
		} else {
