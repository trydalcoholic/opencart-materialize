...
class ControllerBlogCategory extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['categories'][] = array(
				...
				'edit'			=> $this->url->link('blog/category/edit', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $result['category_id'] . $url, true),
				'delete'		=> $this->url->link('blog/category/delete', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $result['category_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('blog/category', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('blog/category', 'user_token=' . $this->session->data['user_token'] . '&sort=sort_order' . $url, true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['category_id'])) {
			...
			$data['action'] = $this->url->link('blog/category/edit', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $this->request->get['category_id'] . $url, true);
		}
		...
		if (isset($this->request->post['category_seo_url'])) {
			...
			$data['category_seo_url'] = $this->model_blog_category->getCategorySeoUrls($this->request->get['category_id']);
		} else {
	...
	protected function validateForm() {
		...
		if (isset($this->request->get['category_id']) && $this->request->post['parent_id']) {
			$results = $this->model_blog_category->getCategoryPath($this->request->post['parent_id']);
