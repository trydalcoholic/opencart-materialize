...
class ControllerBlogPost extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('blog/post', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('blog/post', 'user_token=' . $this->session->data['user_token'] . $url, true)
		);

		$data['add'] = $this->url->link('blog/post/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['copy'] = $this->url->link('blog/post/copy', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('blog/post/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		foreach ($results as $result) {
			...
			$data['posts'][] = array(
				...
				'edit'		=> $this->url->link('blog/post/edit', 'user_token=' . $this->session->data['user_token'] . '&post_id=' . $result['post_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('blog/post', 'user_token=' . $this->session->data['user_token'] . '&sort=pd.name' . $url, true);
		$data['sort_status'] = $this->url->link('blog/post', 'user_token=' . $this->session->data['user_token'] . '&sort=p.status' . $url, true);
		$data['sort_order'] = $this->url->link('blog/post', 'user_token=' . $this->session->data['user_token'] . '&sort=p.sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('blog/post', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['post_id'])) {
			$data['action'] = $this->url->link('blog/post/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
			$data['apply'] = $this->url->link('blog/post/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('blog/post/edit', 'user_token=' . $this->session->data['user_token'] . '&post_id=' . $this->request->get['post_id'] . $url, true);
			$data['apply'] = $this->url->link('blog/post/apply', 'user_token=' . $this->session->data['user_token'] . '&post_id=' . $this->request->get['post_id'] . $url, true);
			$data['post_page'] = HTTP_CATALOG . 'index.php?route=blog/post&post_id=' . $this->request->get['post_id'];
		}

		$data['cancel'] = $this->url->link('blog/post', 'user_token=' . $this->session->data['user_token'] . $url, true);
	...
	public function apply() {
		...
		if (isset($this->request->get['post_id'])) {
			...
			$this->response->redirect($this->url->link('blog/post/edit', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
