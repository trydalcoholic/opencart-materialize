...
class ControllerBlogAuthor extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('blog/author', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['sort_name'] = $this->url->link('blog/author', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('blog/author', 'user_token=' . $this->session->data['user_token'] . '&sort=sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('blog/author', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (isset($this->request->post['author_store'])) {
			...
			$data['author_store'] = $this->model_blog_author->getAuthorStores($this->request->get['author_id']);
		} else {
