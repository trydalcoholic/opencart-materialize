	...
	<div class="col s12 l6">
		<div id="account" class="card-panel z-depth-2">
			...
			<div class="input-field">
				...
				<label for="input-payment-email" data-error="<?php echo $text_email_error; ?>" data-success="<?php echo $text_email_success; ?>" class="active text-bold required"><?php echo $entry_email; ?></label>
			</div>
			<div class="input-field">
