...
<div class="card-panel">
	...
	<div class="row">
		<div class="col s4 m3 l2 center">
			<img class="responsive-img lazyload" src="<?php echo $img_loader; ?>" data-src="catalog/view/theme/materialize/image/comment.png" alt="<?php echo $review['author']; ?>" width="175" height="175">
		</div>
