							...
							<div class="card-panel product-info">
								...
								<ul class="collection z-depth-1">
									...
									<?php if ($sizechart['sizechart_status'] == 1 && $size_chart) { ?>
										<li class="collection-item">
											<i class="material-icons blue-grey-text text-darken-4 left">straighten</i><a class="modal-trigger deep-orange-text text-accent-3 text-bold" href="#modal-size-chart"><?php echo $text_size_chart; ?></a>
										</li>
									<?php } ?>
								</ul>
								<?php } ?>
