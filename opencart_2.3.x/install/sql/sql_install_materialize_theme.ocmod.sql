...
INSERT INTO `oc_url_alias` (`url_alias_id`, `query`, `keyword`) VALUES (NULL, 'blog/category', 'blog'), (NULL, 'blog/author', 'authors');
...
INSERT INTO `oc_materialize_colors` (`color_id`, `name`, `hex`) VALUES
...
CREATE TABLE IF NOT EXISTS `oc_materialize_colors_text` (
	`color_id` INT(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `oc_materialize_colors_text` (`color_id`, `name`, `hex`) VALUES
