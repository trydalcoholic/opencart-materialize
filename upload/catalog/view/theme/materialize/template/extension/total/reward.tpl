<li>
	<div class="collapsible-header grey lighten-5 arrow-rotate"><i class="material-icons">account_balance_wallet</i><span class="text-bold"><?php echo $heading_title; ?></span></div>
